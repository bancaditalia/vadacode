 ...
 *
 * @file Registers the "Add CSV to Input" command.
 */
...
export function registerAddCSVToInputCommand(context: ExtensionContext) {
		commands.registerCommand(
			"vadacode.addCSVToInput", async (fileUri: Uri) => {
